    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">상담원별 현황</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div class="card-box">
                    <h4 class="header-title">상담원별 스트레스 </h4>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-xl-4">
                <div class="card-box">
                    <h4 class="header-title mb-0">스트레스 상위 상담원 (5명)</h4>
                ...
                <div class="card">
                    <div class="card-body" dir="ltr">
                        <div id="cardCollpase3" class="collapse show">
                            <h4 class="header-title mb-3">상담원 스트레스 지수 / 전체평균 비교값</h4>
